...
class SurahListLayout extends Table
{
    /**
     * @var string
     */
    public $target = 'surahs';
    ...
    public function columns(): array
    {
        return [
            ...
            TD::make('name', 'Название')
                ->cantHide(),
            TD::make('total_verses','Кол-во аятов'),
            ...
            TD::make('Действия')
                ...
                ->width('120px')
                ->render(fn(Surah $surah) => DropDown::make()
                    ->icon('bs.three-dots-vertical')
                    ->list([
                        Link::make('Редактировать')
                            ->route('platform.surah.edit', $surah->id)
                            ->icon('bs.pencil'),
